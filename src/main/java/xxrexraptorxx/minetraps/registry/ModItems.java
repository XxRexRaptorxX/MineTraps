...
public class ModItems {
    public static final Item NAILS = registerItem(
            "nails",
            new Item(new Item.Settings()
                    .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(References.MODID, "nails")))));
    public static final Item TOXIN_BUCKET = registerItem(
            "toxin_bucket",
            new BucketItem(
                    ModFluids.TOXIN,
                    new Item.Settings()
                            .registryKey(
                                    RegistryKey.of(RegistryKeys.ITEM, Identifier.of(References.MODID, "toxin_bucket")))
                            .recipeRemainder(Items.BUCKET)
                            .maxCount(1)));
    public static final Item TOXIN_BOTTLE = registerItem(
            "toxin_bottle",
            new ItemToxinBottle(new Item.Settings()
