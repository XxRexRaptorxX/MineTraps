...
public class ModBlocks {
    ...
    public static final Block BARBED_WIRE_FENCE = registerBlock("barbed_wire_fence", new BlockBarbedWireFence(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(References.MODID, "barbed_wire_fence")))));
    ...
    public static final Block EXPLOSIVE_MINE = registerBlock("explosive_mine", new BlockExplosiveMine(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(References.MODID, "explosive_mine")))));
    ...
    public static final Block TOXIC_NAIL_TRAP = registerBlock("toxic_nail_trap", new BlockNailTrap(AbstractBlock.Settings.create()
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(References.MODID, "toxic_nail_trap")))));
    ...
    public static final Block TOXIN = registerBlock("toxin", new BlockToxin(ModFluids.TOXIN, AbstractBlock.Settings.copy(Blocks.WATER)
            .registryKey(RegistryKey.of(RegistryKeys.BLOCK, Identifier.of(References.MODID, "toxin")))){});
    ...
    private static Item registerBlockItem(String name, Block block) {
        return Registry.register(Registries.ITEM, Identifier.of(References.MODID, name),
                new BlockItem(block, new Item.Settings()
                        .registryKey(RegistryKey.of(RegistryKeys.ITEM, Identifier.of(References.MODID, name)))));
    }
