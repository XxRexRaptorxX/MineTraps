...
public class BlockBarbedWireFence extends HorizontalConnectingBlock {
    public static final MapCodec<BlockBarbedWireFence> CODEC =
            BlockBarbedWireFence.createCodec(BlockBarbedWireFence::new);
    ...
    public BlockBarbedWireFence(AbstractBlock.Settings settings) {
        super(
                ...
                16.0F,
                24.0F,
                settings.mapColor(MapColor.IRON_GRAY)
                        .nonOpaque()
                        .noCollision()
                        .requiresTool()
                        .strength(5.0f, 10.0f)
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return ((((super.getPlacementState(ctx)
                                                .with(
                                                        ...
                                                        this.canConnect(
                                                                blockState,
                                                                blockState.isSideSolidFullSquare(
                                                                        blockView, blockPos2, Direction.SOUTH),
                                                                Direction.SOUTH)))
                                        .with(
                                                EAST,
                                                this.canConnect(
                                                        ...
                                                        blockState2.isSideSolidFullSquare(
                                                                blockView, blockPos3, Direction.WEST),
                                                        Direction.WEST)))
                                .with(
                                        SOUTH,
                                        this.canConnect(
                                                blockState3,
                                                blockState3.isSideSolidFullSquare(
                                                        blockView, blockPos4, Direction.NORTH),
                                                Direction.NORTH)))
                        .with(
                                WEST,
                                this.canConnect(
            ...
            if (world instanceof ServerWorld) {
                if (Config.BARBED_WIRE_DESTROY_ITEMS) {
                    entity.damage(
                            ...
                            Config.BARBED_WIRE_FENCE_DAMAGE);
                } else {
