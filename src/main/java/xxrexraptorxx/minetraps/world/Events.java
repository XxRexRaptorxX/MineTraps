...
public class Events {
    ...
    public static void SupporterRewards(PlayerEvent.PlayerLoggedInEvent event) {
        ...
        if (Config.PATREON_REWARDS.get()) {
            try {
                ...
                MineTraps.LOGGER.error("An unexpected error occurred while getting the Supporter URI lists", e);
            }
        }
    }
    ...
    private static boolean SupporterCheck(URI uri, Player player) {
        try {
            ...
            MineTraps.LOGGER.error("Failed to fetch or process supporter list from URI: {}", uri, e);
            return false;
        }
    }
    ...
    private static boolean SupporterCheck(URL url, Player player) {
        try {
            ...
            MineTraps.LOGGER.error("An unexpected error occurred while checking supporter list", e);
        }
