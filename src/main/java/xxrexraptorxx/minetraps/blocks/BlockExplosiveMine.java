    ...
    public void onEntityCollision(
        ...
        if (!world.isClient()) {
            if (this == ModBlocks.TOXIC_MINE) {
                ...
                cloud.setRadius(10);
                cloud.setPotionContents(new PotionContentsComponent(
                        Optional.empty(),
                        Optional.of(0x27ae60),
                        List.of(new StatusEffectInstance(
                                StatusEffects.POISON,
                                Config.POSION_MINE_EFFECT_DURATION,
                                Config.POSION_MINE_EFFECT_AMPLIFIER)),
                        Optional.empty()));
            ...
            entityIn.damage(
                    (ServerWorld) world,
                    MineTrapsDamageTypes.of(entityIn.getWorld(), DamageTypes.GENERIC),
                    Config.MINE_DAMAGE);
