...
public class ModBlocks {
    ...
    public static final DeferredBlock<BlockObstacle> OBSTACLE = registerBlock("obstacle", properties -> new BlockObstacle(properties.requiresCorrectToolForDrops()
    ...
    public static final DeferredBlock<BlockToxin> TOXIN = registerBlock("toxin",
            properties -> new BlockToxin(ModFluids.TOXIN.get(), BlockBehaviour.Properties.ofFullCopy(Blocks.WATER).setId(blockId("toxin"))));
